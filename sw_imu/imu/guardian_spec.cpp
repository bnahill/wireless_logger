...
bool Guardian<CC1101>::init(){
	...
	CC1101::reg_config_t constexpr reg_config[] = {
		...
		{CC1101::REG_MDMCFG4, 0xF8}, // Symbol rate 512Hz
		//{CC1101::REG_MDMCFG4, 0xF5}, // rate 1024Hz
		{CC1101::REG_MDMCFG3, 0x4A},
		{CC1101::REG_MDMCFG2, 0x38}, // OOK, Manchester, no sync
		//{CC1101::REG_MDMCFG2, 0x30}, // OOK, no sync
		{CC1101::REG_MDMCFG1, 0x42},
		{CC1101::REG_MDMCFG0, 0xF8},
		
		{CC1101::REG_DEVIATN, 0x15},
		{CC1101::REG_MCSM2, 0x07},
		{CC1101::REG_MCSM1, 0x30},
		{CC1101::REG_MCSM0, 0x18},
		{CC1101::REG_FOCCFG, 0x16},
		{CC1101::REG_BSCFG, 0x6C},
		{CC1101::REG_AGCCTRL2, 0xA4},
		{CC1101::REG_AGCCTRL1, 0x50},
		{CC1101::REG_AGCCTRL0, 0x92},
		
		// An alternative really-low-gain version
// 		{CC1101::REG_AGCCTRL2, 0xFF},
// 		{CC1101::REG_AGCCTRL1, 0x50},
// 		{CC1101::REG_AGCCTRL0, 0x93}, // 16dB separation
	...
	//iface.set_gdo_mode(CC1101::GDO0, 0x3F); // Nonsense clock out
